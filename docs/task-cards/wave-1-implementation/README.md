...
治理卡 I00；用户已授权持续执行现有卡集，I01 已原子释放为唯一 `READY` 卡。
...
| `W1-I01` | [来源领域内核](W1-I01-source-ingestion-domain.md) | `READY` | `W1-I00` | `W1-IG1` | `HIGH` |
...
| `W1-I04` | [文本、列表与章节](W1-I04-text-list-section-parser.md) | `BLOCKED_BY_DEPENDENCY` | `W1-I03` | `W1-IG4` | `HIGH` |
| `W1-I05` | [表格保真](W1-I05-table-fidelity.md) | `BLOCKED_BY_DEPENDENCY` | `W1-I04` | `W1-IG5` | `HIGH` |
| `W1-I06` | [图片与关系](W1-I06-image-anchor-relationship-projection.md) | `BLOCKED_BY_DEPENDENCY` | `W1-I04,W1-I05` | `W1-IG6` | `HIGH` |
