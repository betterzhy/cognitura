...
| `W0-04` | [JSON Schema Source](W0-04-json-schema-source.md) | `READY` | `W0-02,W0-03` | `W0-G3` | `HIGH` |
...
`W0-03` 与 `W0-06` 已完成，`W0-G2A`、`W0-G4A` 为 `PASS`。W0-04
修复候选的本地门禁已通过，但固定提交深审尚未封口，因此 W0-04 恢复为唯一
`READY` 卡，`W0-G3 = IN_REVIEW`，W0-05 及其后继继续受依赖阻断。
