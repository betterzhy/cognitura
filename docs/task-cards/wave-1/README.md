...
业务实现获准；在 W1-D05 完成并再次取得用户批准前，不得创建 `W1-Ixx` 实现卡。
...
| `W1-D01` | [SourceDocument 契约](W1-D01-source-document-contract.md) | `READY` | `W1-D00` | `W1-DG1` | `HIGH` |
| `W1-D02` | [DocumentBlock 契约](W1-D02-document-block-contract.md) | `BLOCKED_BY_DEPENDENCY` | `W1-D01` | `W1-DG2` | `HIGH` |
| `W1-D03` | [重解析与稳定引用](W1-D03-reparse-reference-contract.md) | `BLOCKED_BY_DEPENDENCY` | `W1-D02` | `W1-DG3` | `HIGH` |
| `W1-D04` | [来源预览与验收](W1-D04-source-preview-acceptance.md) | `BLOCKED_BY_DEPENDENCY` | `W1-D03` | `W1-DG4` | `HIGH` |
