...
PanelInsidePanelInsidePanel = FORBIDDEN
...
HugeRoundedCards = FORBIDDEN
PurpleGradient = FORBIDDEN
Glassmorphism = FORBIDDEN
FloatingPillsEverywhere = FORBIDDEN
OversizedHeroTitles = FORBIDDEN
ExcessiveEmptyMarketingSpace = FORBIDDEN
EmojiIconSystem = FORBIDDEN
RainbowAIGlow = FORBIDDEN
GradientBorders = FORBIDDEN
EverySectionInACard = FORBIDDEN
