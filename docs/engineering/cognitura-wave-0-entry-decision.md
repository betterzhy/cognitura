...
| `W0-G3 JsonSchemaValidation` | `IN_REVIEW` | 修复候选的 14 份 Schema、2 个合法空值上下文、34 个语义反例、68 个运行时语义错误码、645 条精确 Schema 证据映射、16 条语义不变量证据、6 个映射篡改反例和全量渲染 round-trip 通过；等待固定提交深审 |
