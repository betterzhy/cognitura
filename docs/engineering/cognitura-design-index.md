...
| `W1-D04` | `docs/design/wave-1/cognitura-source-preview-contract-1.0.md` | `READY` | `W1-DG4 PENDING` |
| `W1-D05` | `docs/engineering/cognitura-wave-1-design-acceptance.md` | `BLOCKED_BY_DEPENDENCY` | `W1-DG5 PENDING` |

未落地的 W1-D04 至 W1-D05 路径是已批准设计计划中的目标产物，不得作为已存在
的正式设计引用。当前 W1-D00 治理说明及 W1-D01 至 W1-D03 三份来源契约已通过
各自 Gate。
