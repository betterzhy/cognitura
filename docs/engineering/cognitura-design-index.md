...
| `W1-D03` | `docs/design/wave-1/cognitura-reparse-reference-contract-1.0.md` | `READY` | `W1-DG3 PENDING` |
...
未落地的 W1-D03 至 W1-D05 路径是已批准设计计划中的目标产物，不得作为已存在
的正式设计引用。当前 W1-D00 治理说明、W1-D01 SourceDocument 契约和 W1-D02
DocumentBlock 契约已通过各自 Gate。
